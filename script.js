...
document.getElementById('calculate').addEventListener('click', () => {
  ...
  const params = {
    ...
    tours_briques: parse('tours_briques'),
  ...
  const eTB   = ((params.cons_t_terre * params.d_briques) / 100) * 2.68 * params.tours_briques;
  const eR    = ((params.cons_rapat * (params.d_terre*2)) / 100) * 2.68 * params.tours_rapat;
